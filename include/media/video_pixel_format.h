 ...
 *        Implements video pixel format stable codes
 */
enum VideoPixelFormat {
  VideoPixelFormat_NONE = 0,   ///< Invalid or not specified value for pixel format
  ...
  VideoPixelFormat_NV21,       ///< as NV12, but U and V bytes are swapped             27
  ...
  VideoPixelFormat_RGB555BE,     ///< packed RGB 5:5:5, 16bpp, (msb)1A 5R 5G
                                 ///< 5B(lsb), big-endian, most significant bit to 0
  VideoPixelFormat_RGB555LE,     ///< packed RGB 5:5:5, 16bpp, (msb)1A 5R 5G
                                 ///< 5B(lsb), little-endian, most significant bit to 0
  ...
  VideoPixelFormat_BGR555BE,     ///< packed BGR 5:5:5, 16bpp, (msb)1A 5B 5G
                                 ///< 5R(lsb), big-endian, most significant bit to 1
  VideoPixelFormat_BGR555LE,     ///< packed BGR 5:5:5, 16bpp, (msb)1A 5B 5G
                                 ///< 5R(lsb), little-endian, most significant bit to 1
...
#endif  // VIDEO_PIXEL_FORMAT_HEADER
